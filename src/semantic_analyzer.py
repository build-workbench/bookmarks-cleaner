...
class SemanticAnalyzer:
    ...
    def _calculate_similarity(
        self, text_words: List[str], category_keywords: List[str]
    ) -> float:
        """计算文本与分类关键词的相似度"""
    ...
    def _combine_semantic_scores(
        self, domain_scores: Dict, title_scores: Dict, path_scores: Dict
    ) -> Dict[str, float]:
        """综合语义评分"""
        combined = {}
        all_categories = (
            set(domain_scores.keys())
            | set(title_scores.keys())
