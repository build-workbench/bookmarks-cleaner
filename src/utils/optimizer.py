    ...
    def get_performance_summary(self) -> Dict:
        ...
        if self.system_metrics:
            ...
            summary["system"] = {
                ...
                "min_available_memory_gb": min(
                    m.memory_available for m in self.system_metrics
                ),
            }
                ...
                bottlenecks.append(
                    {
                        ...
                        "severity": (
                            "high" if stats["avg_execution_time"] > 5.0 else "medium"
                        ),
                    }
                )
                ...
                bottlenecks.append(
                    {
                        ...
                        "severity": (
                            "high" if stats["max_memory_usage"] > 500 else "medium"
                        ),
                    }
                )
...
def performance_monitor(
    func: Optional[Callable] = None, *, enable_cache=False, cache_size=128
):
    """性能监控装饰器"""
...
class CacheManager:
    ...
    def get_stats(self) -> Dict:
        ...
        expired_count = sum(
            1
            for creation_time in self.creation_times.values()
