...
try:
    from src.enhanced_classifier import EnhancedBookmarkFeatures, EnhancedClassifier
except Exception:
...
class TestDataGenerator:
    ...
    def generate_bookmarks(count: int = 100) -> List[Dict]:
        ...
        categories = ["技术栈", "AI", "娱乐", "新闻", "学习", "工具", "社区", "文档"]
...
class TestEnhancedClassifier(unittest.TestCase):
    ...
    def test_learning_from_feedback(self):
        ...
        self.classifier.learn_from_feedback(
            url, title, "技术栈", initial_result.category
        )
...
class TestMLClassifier(unittest.TestCase):
    ...
    @unittest.skipIf(
        not hasattr(sys.modules.get("sklearn"), "__version__"), "sklearn not available"
    )
...
class TestAdvancedFeatures(unittest.TestCase):
    ...
    def test_deduplicator(self):
        ...
        bookmarks = [
            ...
            {
                "url": "https://example.com/page1?utm_source=test",
                "title": "Test Page",
            },  # URL参数不同
    ...
    def test_recommendation_system(self):
        ...
        recommendations = recommender.recommend_categories(
            "https://github.com/test/repo", "Test Repository"
        )
...
<DL><p>
    ...
    def test_end_to_end_processing(self):
        ...
        processed_bookmarks = processor.process_bookmarks(
            [self.html_file], show_progress=False
        )
...
def run_pytest():
    ...
    # pytest配置
    args = [__file__, "-v", "--tb=short", "--maxfail=5"]
