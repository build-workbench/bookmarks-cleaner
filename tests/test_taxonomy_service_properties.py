...
# 策略定义
# 有效的分类名称：字母、数字、中文、空格、连字符
valid_name_strategy = st.from_regex(
    r'^[\w\u4e00-\u9fff][\w\u4e00-\u9fff\s\-]{0,30}$',
    fullmatch=True
...
class TestTaxonomyYAMLRoundTrip:
    ...
    def test_taxonomy_yaml_round_trip(self, service, categories):
        """
        Property 19: Taxonomy YAML Round-Trip
        ...
        # 获取当前层级结构
        hierarchy_before = service.get_hierarchy()
        ...
        # 验证结构等效
        hierarchy_after = service.get_hierarchy()
    ...
    def test_hierarchical_round_trip(self, service, parent, children):
        """
        层级结构应该在往返后保持。
        """
...
class TestCategoryNameValidation:
    ...
    def test_valid_category_names_accepted(self, service, name):
        """
    ...
    def test_invalid_category_names_rejected(self, service, name):
        """
    ...
    def test_name_length_limit(self, service):
        """
        名称长度应该被限制在50字符以内。
        """
        # 50字符应该有效
    ...
    def test_chinese_names_accepted(self, service):
        """
        中文名称应该被接受。
        """
...
class TestCategoryRenamePropagation:
    ...
    def test_category_rename_propagation(self, service, old_name, new_name):
        """
        Property 21: Category Rename Propagation
    ...
    def test_rename_preserves_variants(self, service):
        """
        重命名应该保留现有的变体。
        """
        # 添加分类
...
class TestCategoryMergeCompleteness:
    ...
    def test_category_merge_completeness(self, service, source, target):
        """
        Property 22: Category Merge Completeness
    ...
    def test_merge_preserves_children(self, service):
        """
        合并应该保留子分类。
        """
        # 创建带子分类的源
...
class TestMigrationExport:
    ...
    def test_migration_export(self, service):
        """
        迁移脚本应该记录所有变更。
        """
        # 执行一系列操作
