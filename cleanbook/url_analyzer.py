...
class URLAnalysis:
    ...
    category_hints: List[Tuple[str, float]] = field(default_factory=list)
...
class URLAnalyzer:
    ...
    def analyze(self, url: str) -> URLAnalysis:
        try:
            ...
            analysis = URLAnalysis(
                ...
                site_type=site_type, content_type=content_type,
            )
            self._extract_repo_info(analysis, path)
            ...
            return URLAnalysis(
                domain="", subdomain="", path="", path_segments=[],
                query_params={}, site_type="unknown", content_type="unknown",
            )

    def _identify_site_type(self, domain, subdomain, path, path_segments) -> Tuple[str, str]:
    ...
    def _identify_video_content(self, domain: str, path: str, path_segments: List[str]) -> str:
    ...
    def _extract_repo_info(self, analysis: URLAnalysis, path: str):
    ...
    def _detect_language(self, analysis: URLAnalysis, path: str, path_segments: List[str]):
        if path_segments:
        ...
        lang_keywords = {
            ...
            "golang": "Go", "rust": "Rust", "java": "Java", "kotlin": "Kotlin",
            "swift": "Swift", "cpp": "C++",
        }
